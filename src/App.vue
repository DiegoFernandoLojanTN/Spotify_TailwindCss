    ...
    <div class="absolute w-full bg-neutral-900 bottom-0 h-24 border-t border-neutral-700">
      ...
      <div class="px-4 flex justify-between h-full">
        <div class="flex items-center gap-x-4">
          ...
          <div>
            <img class="w-14" src="/images/thumb-song.jpg" alt="">
          </div>
          <div>
            <button class="text-sm hover:underline block">No te preocupes por mí</button>
            <button class="text-xs hover:underline block">Leiva</button>
          </div>
          <div>
            <Like
              :like="true"
